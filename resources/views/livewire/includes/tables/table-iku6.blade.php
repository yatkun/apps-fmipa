                    ...
                    <div>
                        <div class="inline-flex gap-x-2">
                            ...
                            <button type="button" wire:click="modes"
                                ...
                                aria-haspopup="dialog" aria-expanded="false" aria-controls="ModalAddIku6"
                                                ...
                                                <td>
                                                    <div class="flex gap-2">
                                                        <div class="flex gap-2">
                                                            ...
                                                            <button wire:click="deleteIku6({{ $item->id }})"
