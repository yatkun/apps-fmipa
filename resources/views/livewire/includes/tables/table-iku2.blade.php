            ...
            <div
                ...
                <div
                    ...
                    <div class="relative max-w-xs">
                        ...
                        <input wire:model.live.debounce.300ms="searcha" type="text" name="hs-table-search"
                    ...
                    <div>
                        <div class="inline-flex gap-x-2">
                            ...
                            <button type="button" wire:click="modes" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-full cursor-pointer gap-x-2 hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
