            ...
            <div
                ...
                <div
                    ...
                    <div class="relative max-w-xs">
                        <label for="hs-table-input-search" class="sr-only">Cari data</label>
                    ...
                    <div>
                        <div class="inline-flex gap-x-2">
                            ...
                            <button type="button" wire:click="modes"
                                ...
                                aria-haspopup="dialog" aria-expanded="false" aria-controls="ModalAddIku7"
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                        @foreach ($a as $item)
                                            <tr>
                                                ...
                                                <td
                                                    class="p-3 text-sm text-gray-800 whitespace-nowrap dark:text-neutral-200">
                                                    <a target="_blank" href="{{ $item->link }}" class="p-2 text-sm text-white bg-blue-400 rounded-md">Lihat RPS</a></td>
                                                <td>
                                                    <div class="flex gap-2">
                                                        <div class="flex gap-2">
                                                            ...
                                                            <button wire:click="deleteIku7({{ $item->id }})"
