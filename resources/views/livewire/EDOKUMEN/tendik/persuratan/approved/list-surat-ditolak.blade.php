                 ...
                 <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Daftar Surat yang Ditolak</h4>
                                    ...
                                    <table id="example" class="table mt-3 table-bordered dt-responsive nowrap w-100"
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 20%" wire:click="setsortBy('created_at')"
                                                    class="sortable-column sorting_asc">
                                                    <x-datatable-items columnName="Tanggal Ditolak"
                                                        :sortBy="$sortBy"></x-datatable-items>
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($tolak as $letter)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a wire:navigate="" href="http://localhost:8000/dokumen/persuratan/generate-letter/48" class="btn btn-sm btn-soft-success">
                                                                <i class="mdi mdi-pencil"></i></a>
 <button type="button" class="btn btn-sm btn-soft-primary" data-bs-toggle="tooltip" data-bs-placement="left" title="{{ $letter->rejection_reason }}">
