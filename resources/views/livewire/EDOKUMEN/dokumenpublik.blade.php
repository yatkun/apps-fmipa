...
<div class="main-content">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                ...
                                                data-bs-target=".bs-example-modal-center" class="dropdown-item" 
                                                   >Upload Dokumen</button>
                                                <button class="dropdown-item" data-bs-toggle="modal"
                                                    data-bs-target=".modal-link">Link Dokumen</button>
                                            </div>
                                        </div>
                                ...
                                <table id="example" class="table mt-3 table-bordered dt-responsive nowrap w-100"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 20%" wire:click="setsortBy('created_at')" class="sorting_asc">
                                                ...
                                                <td>
                                                    <ul class="gap-1 mb-0 list-unstyled hstack">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="Download">
                                                            <a wire:click="download({{ $i->id }})" wire:loading.attr="disabled"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> {{ $mode == 'edit' ? 'Edit' : 'Tambah' }} Dokumen Publik
                    </h5>
                ...
                <form wire:submit="handleSaveOrUpdate" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                @if ($existingFile)
                                    <p>File Saat Ini:
                                        <button wire:click="download({{ $i->id }})" type="button"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" wire:click="cancelEdit" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
        </div>
    ...
    <div wire:ignore.self class="modal fade bs-example-modal-center modal-link" role="dialog" id="modal2">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> {{ $mode == 'edit' ? 'Edit' : 'Tambah' }} Dokumen Publik
                ...
                <form wire:submit="submit_link"  >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" id="example-text-input"
                                    wire:model="document" placeholder="Masukkan link google drive" name="document">
                            </div>
                        </div>
