            ...
            <div class="modal-content">
                ...
                <form wire:submit="save">
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            <label class="col-md-2 col-form-label">Jenis Karya <span class="text-danger">*</span></label>
                            <div class="col-md-10">
                                <select class="form-select" wire:model.change="form.jenis_karya">
                        ...
                        <div class="mb-3 row">
                            <label for="example-date-input" class="col-md-2 col-form-label">Tanggal Terbit <span class="text-danger">*</span></label>
                            <div class="col-md-3">
