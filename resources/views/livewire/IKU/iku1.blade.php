                                                        ...
                                                        @foreach ($ikusatu as $item)
                                                            <tr>
                                                                ...
                                                                <td
                                                                    ...
                                                                    class="p-3 text-sm text-gray-800 whitespace-nowrap dark:text-neutral-200">
                                                                    @if ($item->bukti)
                                                                        <a href="{{ $item->bukti }}" target="_blank" class="p-2 text-xs text-white bg-blue-400 rounded-md">Bukti dokumen</a>
                                                                    @else
                                                                       Belum ada 
                                                                    @endif</td>
                                                                <td>
                                                                    <div class="flex gap-2">
                                                                        <div class="flex gap-2">
                                                                            <button aria-label="Close"
                                                                                ...
                                                                                class="object-center p-2.5 text-xs text-white bg-yellow-500 rounded-md hover:bg-yellow-600 dark:bg-yellow-500/10 dark:text-yellow-500 hover:dark:bg-yellow-500/30"><svg
                                                                            ...
                                                                            <button wire:click="deleteIku1({{ $item->id }})"
                                                                                class="p-2.5 text-center text-xs text-white bg-red-600 rounded-md hover:bg-red-700 dark:bg-red-500/10 dark:text-red-500 hover:dark:bg-red-500/30"><svg
                                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                                    viewBox="0 0 24 24" fill="currentColor"
                                                                                    class="size-4">
                                            ...
                                            <div
                                                ...
                                                <table
                                                    ...
                                                    <thead class="bg-gray-50 dark:bg-neutral-800">
                                                        <tr>
                                                            <th scope="col"
                                                                class="px-6 py-2 text-xs font-medium text-gray-500 uppercase border-r dark:border-neutral-700 dark:text-neutral-400">
                                                                Pekerjaan</th>
                                                            <th scope="col"
                                                                class="px-6 py-2 text-xs font-medium text-gray-500 uppercase dark:text-neutral-400">
                                                                Jumlah</th>
                                                    ...
                                                    <tbody
                                                        ...
                                                        <tr>
                                                            <td
                                                                class="px-6 py-2 text-xs font-medium text-gray-500 uppercase border-r dark:bg-neutral-800 bg-gray-50 dark:border-neutral-700 dark:text-neutral-400">
                                                                Bekerja</td>
                                                            <td
                    ...
                    <div
                        ...
                        <div class="p-6 overflow-y-auto">
                            ...
                            <div class="grid gap-2 sm:grid-cols-12 sm:gap-6">
                                ...
                                <div class="sm:col-span-9">
                                    <div class="space-y-2">
                                        <select id="af-submit-app-category" name="pekerjaan"
