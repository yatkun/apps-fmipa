<div>
    <header class="sticky inset-x-0 z-50 flex flex-wrap w-full top-4 md:justify-start md:flex-nowrap">
        <div class="relative max-w-[66rem] w-full md:flex md:items-center lg:mx-auto md:gap-2">
        <nav class=" dark:bg-neutral-800 bg-primary w-full rounded-[28px] py-3 ps-5 pe-2 md:flex md:items-center md:justify-between md:py-0 mx-2 lg:mx-auto before:bg-primary dark:bg-neutral-800/30 backdrop-blur-md"
            aria-label="Global">
            <div class="flex items-center justify-between">
                <!-- Logo -->
                <a class="flex-none inline-block text-xl font-semibold rounded-md focus:outline-none focus:opacity-80"
                    href="#" aria-label="Preline">
                    <svg class="w-14"  id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 502.63 256.66">
                        <defs>
                          <style>
                            .cls-1 {
                              fill: #fff;
                        ...
                        <g id="Layer_1-2" data-name="Layer 1">
                          <g>
                            <g>
                              <path class="cls-1" d="M54,130.85c-3.03,7.2-7.1,12.62-12.21,16.28-5.11,3.65-11.32,5.48-18.63,5.48-4.38,0-8.43-.65-12.13-1.96-3.71-1.31-7.28-3.31-10.72-6.03l10.17-16.75c3.65,2.92,7.3,4.38,10.96,4.38,2.5,0,4.7-.65,6.57-1.96,1.88-1.31,3.39-3.26,4.54-5.87l2.35-5.01L0,37.09H24.89l22.07,58.85,19.88-58.85h24.1l-36.94,93.75Z"/>
                              <path class="cls-1" d="M128.81,84.68c-4.59,0-8.04,.78-10.33,2.35-2.3,1.57-3.44,4.07-3.44,7.51s1.17,5.97,3.52,7.9c2.35,1.93,5.56,2.9,9.63,2.9,3.55,0,6.7-.6,9.47-1.8,2.76-1.2,5.06-2.82,6.89-4.85,1.82-2.03,2.95-4.41,3.37-7.12l3.6,13.46c-2.4,5.63-6.16,9.91-11.27,12.83-5.11,2.92-11.37,4.38-18.78,4.38-5.95,0-11.09-1.15-15.42-3.44-4.33-2.29-7.67-5.42-10.02-9.39-2.35-3.96-3.52-8.45-3.52-13.46,0-7.83,2.76-13.98,8.29-18.47,5.53-4.49,13.46-6.78,23.79-6.89h25.67v14.09h-21.44Zm18.94-15.65c0-4.59-1.49-8.19-4.46-10.8-2.97-2.61-7.33-3.91-13.07-3.91-3.76,0-7.77,.65-12.05,1.96-4.28,1.31-8.61,3.16-12.99,5.56l-7.51-15.65c4.17-2.19,8.24-4.02,12.21-5.48,3.96-1.46,8.03-2.58,12.21-3.37,4.17-.78,8.71-1.17,13.62-1.17,11.37,0,20.14,2.66,26.3,7.98,6.16,5.32,9.29,12.68,9.39,22.07l.16,54.94h-23.63l-.16-52.12Z"/>
                              <path class="cls-1" d="M193.14,5.01h24.1V121.15h-24.1V5.01Zm54.94,32.09h27.39l-59.63,62.45v-28.33l32.24-34.12Zm-5.48,29.58l34.28,54.47h-28.49l-23.48-40.07,17.69-14.4Z"/>
                              <path class="cls-1" d="M301.3,0c3.86,0,7.02,1.25,9.47,3.76,2.45,2.5,3.68,5.63,3.68,9.39s-1.23,6.89-3.68,9.39c-2.45,2.5-5.61,3.76-9.47,3.76-3.65,0-6.73-1.25-9.23-3.76-2.5-2.5-3.76-5.63-3.76-9.39s1.25-6.89,3.76-9.39c2.5-2.5,5.58-3.76,9.23-3.76Zm-12.05,37.09h24.1V121.15h-24.1V37.09Z"/>
over:text-neutral-300 md:py-4 focus:outline-none focus:text-neutral-300"
                        href="../../templates/agency/index.html" aria-current="page">Beranda</a>
                    <a class="text-white text-md hover:text-neutral-300 md:py-4 focus:outline-none focus:text-neutral-300"
                        href="#">Fitur</a>
                    <a class="text-white text-md hover:text-neutral-300 md:py-4 focus:outline-none focus:text-neutral-300"
                        href="#">Paket</a>
                    ...
                    <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:py-4">
                        <button type="button"
                            class="flex items-center w-full text-white text-md hover:text-neutral-300 focus:outline-none focus:text-neutral-300">
                            Tentang Kami
                        ...
                        <div
                            ...
                            <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-md text-white hover:text-neutral-300 font-medium focus:outline-none focus:text-neutral-300"
                                href="#">
                                About
                            </a>
                            <div
                                ...
                                <button type="button"
                                    class="flex items-center justify-between w-full px-3 py-2 text-sm font-medium text-white hover:text-neutral-300 focus:outline-none focus:text-neutral-300">
                                    Sub Menu
                    ...
                    <div class="flex gap-2">
                        <a class="inline-flex items-center px-4 py-2 text-white border rounded-full cursor-pointer text-md dark:border-primary dark:text-primary group gap-x-2 focus:outline-none"
                            href="{{ route('auth.login') }}">
                            Daftar
                        </a>
                        <a class="inline-flex items-center px-4 py-2 bg-white rounded-full cursor-pointer text-md group gap-x-2 dark:bg-primary text-primary dark:text-neutral-800 focus:outline-none"
                            href="{{ route('auth.login') }}">
                            Masuk
                        </a>
                    </div>
        ...
        <div class="">
            <button type="button"
                class="block font-medium text-white rounded-full bg-neutral-800 hs-dark-mode-active:hidden hs-dark-mode focus:outline-none focus:bg-gray-200 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                data-hs-theme-click-value="dark">
                <span class="inline-flex items-center justify-center group shrink-0 size-12">
            ...
            <button type="button"
                class="hidden font-medium text-gray-800 rounded-full bg-neutral-800 hs-dark-mode-active:block hs-dark-mode hover:bg-gray-200 focus:outline-none focus:bg-gray-200 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
    ...
    <main id="content">
        ...
        <div class="bg-white dark:bg-neutral-900">
            <div class="max-w-5xl px-4 pt-24 pb-24 mx-auto xl:px-0 lg:pt-4">
                <div class="flex place-items-center">
                    <div>
                        <h1 class="text-5xl font-semibold text-gray-800 dark:text-white md:text-6xl">
                            <span class="dark:text-accent text-primary">Yakin Lulus:</span> Satu Langkah Menuju Sukses
                        </h1>
                        <div class="max-w-4xl">
                            <p class="mt-5 text-lg text-gray-800 dark:text-neutral-400">
                                Yakin Lulus adalah Suatu Platform Belajar & Tryout Online untuk CPNS / PPPK / Tes Masuk PT
                            </p>
                        </div>
                    </div>
                    <div>
        ...
        <!-- Clients -->
        <div class="relative pt-4 overflow-hidden bg-white dark:bg-neutral-900">
            <svg class="absolute -bottom-20 start-1/2 w-[1900px] transform -translate-x-1/2" width="2745"
                ...
                <path
                    ...
                    class="stroke-primary/20 dark:stroke-neutral-700/50" stroke="currentColor" />
                <path
        ...
        <!-- Case Stories -->
        <div class="bg-white dark:bg-neutral-900 dark:bg-gradient-to-t from-black to-transparent">
            <div class="max-w-5xl px-4 py-24 mx-auto xl:px-0">
                <!-- Title -->
                <div class="max-w-3xl mb-10 lg:mb-14">
                    <h2 class="text-2xl font-semibold text-gray-800 dark:text-white md:text-4xl md:leading-tight">Success stories</h2>
                ...
                <!-- Card Grid -->
                <div
                    class="grid items-center grid-cols-1 border divide-y lg:grid-cols-3 border-neutral-700 lg:divide-y-0 lg:divide-x divide-neutral-700 rounded-xl">
                    <!-- Card -->
            ...
            <div class="max-w-5xl px-4 py-10 mx-auto xl:px-0 lg:py-20">
                ...
                <div class="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
                    <div>
                        ...
                        <blockquote>
                            <p
                                class="text-xl font-medium text-white md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal">
                    ...
                    <div class="space-y-14">
                        ...
                        <div class="flex gap-x-5">
                            ...
                            <div class="grow">
                                ...
                                <a class="mt-1 text-sm text-neutral-400" href="#mailto:example@site.co"
                                    target="_blank">
                                    hello@example.so
                                </a>
                            </div>
